...
const Topbar = () =>{
    ...
    return(
        <>
            ...
            >
                <Link to={'/screen1'} className="" aria-label="navigate to sign in page" title="back to sign in">
                ...
                <button onClick={handleStarClick} title="like">
                    <svg ref={starRef} width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
